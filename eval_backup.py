...
if __name__ == "__main__":
    ...
    speaker_path = args.pretrained_path + "/files/speaker_model.pt"
    tokenizer = transformers.RobertaTokenizer.from_pretrained("roberta-base")
    if args.use_tom:
        listener_path = args.pretrained_path + "/files/tom_listener.pt"
    ...
    torch.save(all_actions, args.pretrained_path + '/files/all_actions.pt')
    torch.save(all_feedback, args.pretrained_path + '/files/all_feedback.pt')
